...
describe("section card-wrap", () => {
  test("section with prose children wraps prose in .card div", () => {
    const block: Block = {
      type: "section",
      title: "Goals",
  ...
  test("section with nested section child: nested section is NOT inside a card", () => {
    const block: Block = {
      type: "section",
      title: "Parent",
      children: [
  ...
  test("section with mix of prose and nested section: prose in card, nested section after", () => {
    const block: Block = {
      type: "section",
      title: "Mixed",
      children: [
  ...
  test("section with no children renders no card", () => {
    const block: Block = { type: "section", title: "Empty", children: [] };
    const result = renderBlock(block, makeCtx());
    expect(result).not.toContain('<div class="card">');
  });

  test("section with only a nested section child renders no card at parent level", () => {
    const block: Block = {
      type: "section",
      title: "Parent",
      children: [
  ...
  test("section card-wrap: callout and code blocks are grouped in a card", () => {
    const block: Block = {
      type: "section",
      title: "Overview",
      children: [
